...
- (id)init {
    ...
    if (self) {
        ...
        self.items = @[@"册报到后请同学们及时开始课程",@"各选课学校的规定执行，选课学校清退后请及时通",@"校的规定执行，选课学校清退后请及时通知智慧树平台。如果选课学校没有规定的，课程中心平台执行清退的最后截止时间为3月30日24:00点。其它区域的选课学校：如果选课学校有规定的请以正式函的形式通知课程中心平台，若没有特别说明的，课程中心平台统一的最后清退截止"];
    }
    return self;
}
